...
public partial class MasaViewModel : ObservableObject
{
    ...
    public string DurumBilgiText => Durum switch
    {
        MasaDurum.Bos => "Müsait",
        MasaDurum.Aktif => "Dolu",
        MasaDurum.SiparisBekliyor => "Sipariş Bekliyor",
        MasaDurum.Arizali => "Arızalı",
        _ => ""
    };

    public string SureText => GecenSureText;

    public decimal ToplamTutar => ToplamBorc;
    ...
    partial void OnDurumChanged(MasaDurum value)
    {
        ...
        OnPropertyChanged(nameof(DurumBilgiText));
    ...
    partial void OnGecenSureTextChanged(string value)
    {
        OnPropertyChanged(nameof(SureText));
    }

    partial void OnToplamBorcChanged(decimal value)
    {
